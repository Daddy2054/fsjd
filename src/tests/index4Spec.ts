import countries from "../index4";

xit("should get basic data on the country canada", async () => {
...
xit("should get countries of NAFTA regional block", async () => {
...
xit("should get capitals of NAFTA countries", async () => {
